...
class ProgressiveManager {
    ...
    hire(employee) {
        this.reports.push(employee);
        this.reports.length > 100 ? this.title = 'Bestest Manager' :
            this.reports.length > 50 ? this.title = 'Manager Plus' :
                this.reports.length > 10 ? this.title = 'Manager' :
                    this.reports.length > 3 ? this.title = 'Mostly Manager' :
                        this.reports.length > 0 ? this.title = 'Barely Manager' :
                            this.title = 'Not a manager';
    }
    fire(index) {
        this.reports.splice(index, 1);
